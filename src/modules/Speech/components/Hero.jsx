      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl lg:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animate-delay-200 font-medium">
            Read amazing stories and record your voice! Our friendly AI helps analyze speech patterns 
            to support learning. 📚🎤
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-fade-in-up animate-delay-300">
            <button
              onClick={handleStartReadingTask}
              className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-bold px-10 py-5 rounded-full text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border-2 border-white/20"
            >
            ...
            <button 
              onClick={() => navigate('/speech/features')}
              className="bg-white/20 hover:bg-white/30 text-white border-2 border-white/30 hover:border-white/50 font-bold px-10 py-5 rounded-full text-lg shadow-lg transform hover:scale-105 transition-all duration-300"
            >
              <span className="flex items-center gap-2">
                <span>ℹ️</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto animate-fade-in-up animate-delay-400">
            ...
            <div className="text-center bg-purple-400/15 backdrop-blur-sm rounded-2xl p-6 border border-purple-400/20 transform hover:scale-105 transition-all">
              ...
              <div className="text-white/80 text-sm font-medium">Fast Analysis</div>
            </div>
            <div className="text-center bg-pink-400/15 backdrop-blur-sm rounded-2xl p-6 border border-pink-400/20 transform hover:scale-105 transition-all">
              ...
              <div className="text-white/80 text-sm font-medium">Always Ready</div>
            </div>
          </div>
        </div>
      </div>

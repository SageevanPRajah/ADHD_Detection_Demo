...
const AnalyzePage = () => {
  ...
  const [initialChildAge, setInitialChildAge] = useState(8);
  ...
  useEffect(() => {
    const pendingChildAge = sessionStorage.getItem('pendingChildAge');
    if (pendingChildAge) {
      setInitialChildAge(parseInt(pendingChildAge));
      sessionStorage.removeItem('pendingChildAge');
    }
  }, []);
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-md rounded-3xl shadow-large p-8 lg:p-12 card-hover border border-white/20">
              ...
              <FileUpload
                ...
                initialChildAge={initialChildAge}
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="bg-red-500/20 backdrop-blur-md rounded-2xl p-8 shadow-medium border border-red-400/30">
                ...
                <button
                  ...
                  className="btn-secondary bg-white/20 hover:bg-white/30 border-white/30 text-white hover:text-white"
                >
                  Try Again
                </button>

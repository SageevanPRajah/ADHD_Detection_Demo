        ...
        <section className="min-h-[calc(100vh-5rem)] flex items-center justify-center">
          <div className="container-custom">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white">{t('speech.analyzingPatterns')}</h3>
              <p className="text-white/80 mb-8">{t('speech.analyzingWait')}</p>
      ...
      <section id="results" className="section-padding">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">{t('speech.analysisComplete')}</h2>
            <p className="text-xl text-white/80">{t('speech.analysisCompleteDesc')}</p>
          </div>
